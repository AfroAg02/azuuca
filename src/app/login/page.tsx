          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-11 py-3 bg-gray-50/80 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/40 focus:border-blue-400 focus:bg-white outline-none transition-all"
                placeholder="••••••••"
                required
              />
              <button
